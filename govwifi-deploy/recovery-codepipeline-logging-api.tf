resource "aws_codepipeline" "recovery_logging_api_pipeline" {
  name     = "DEV-recovery-logging-api-pipeline"
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        RepositoryName = "govwifi/logging-api/recovery"
      }
    }
  }
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ...
        ServiceName : "logging-api-service-recovery"
      }
    }
  }
