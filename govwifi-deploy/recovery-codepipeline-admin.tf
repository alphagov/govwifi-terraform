resource "aws_codepipeline" "recovery_admin_pipeline" {
  name     = "DEV-recovery-admin-pipeline"
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        RepositoryName = "govwifi/admin/recovery"
      }
    }
  }
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ClusterName : "recovery-admin-cluster"
        ServiceName : "admin-recovery"
      }
    }
