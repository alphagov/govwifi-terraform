...
module "dublin_backend" {
  ...
  bastion_ssh_key_name      = "govwifi-recovery-bastion-20240910"
  ...
  user_replica_source_db = "arn:aws:rds:eu-west-2:${local.aws_account_id}:db:wifi-recovery-user-db"
...
module "dublin_keys" {
  ...
  govwifi_bastion_key_name = "govwifi-recovery-bastion-20240910"
  govwifi_bastion_key_pub  = "ssh-rsa  govwifi-developers@digital.cabinet-office.gov.uk"

  create_production_bastion_key = 0

  govwifi_key_name     = var.ssh_key_name
  govwifi_key_name_pub = "ssh-rsa  govwifi-developers@digital.cabinet-office.gov.uk"
...
module "dublin_route53_notifications" {
  ...
  topic_name = "govwifi-recovery-dublin"
...
module "dublin_notifications" {
  ...
  topic_name = "govwifi-recovery-dublin-capacity"
  emails     = [var.notification_email]
}
...
module "dublin_critical_notifications" {
  ...
  topic_name = "govwifi-recovery-dublin-critical"
  emails     = [var.notification_email]
}
